...
INSERT INTO Reviewer (ReviewerEmailAddr, FirstName, LastName, PhoneNum, AuthorFeedback, CommitteeFeedback, Affiliation, TopicId) VALUES ('reviewer1@reviewer.com', 'Vitalik', 'Buterin', '1234567890', 'Great job, although I like ethereum better', 'What are you a bitcoin maximalist?', 'US Mint', 1), 
...
INSERT INTO Paper (Id, Title, Abstract, FileName, AuthorId) VALUES 
(1, 'My Favorite Crypto Currency - Why Bitcoin is the best', 'Bitcoin is the best because it is the first true crypto currency', 'bitcoin.doc', 'mb18974p@pace.edu'),
(2, 'Why I love to Bake - How Baking calms the soul', 'Baking is very calming to me and is a relaxing activity I like to do with my husband Matt on Sunday mornings', 'bakingisfun.doc', 'dalilacastillo3@gmail.com'), 
(3, 'Squeaky toys are better than tennis balls', 'Bark bark bark bark, squeaky toys are the best, woof woof woof, bark bark. I also love when mom and dad give me treats!', 'squeakytoysalltheway.doc', 'bailey@gooddog.com'), 
(4, 'My experience nursing', 'Being a nurse can be a challenging and rewarding career', 'nursing.doc', 'aliciabrown@yahoo.com'), 
(5, 'The red sox are the best team ever', 'The red sox are wicked awesome and the best baseball team around', 'redsox.doc', 'timbrown@gmail.com'), 
(6, 'Why I moved to Portland, OR', 'I moved to Portland, OR to be with my fiancee Alex and to get my PhD in Neuro Science', 'portland.doc', 'kellybrown@gmail.com'),
(7, 'Wedding Planning Process - Getting Married in December', 'I am gettng married in December and this wedding planning is easier than I thought', 'weddingplanning.doc', 'chrisbrown@gmail.com');
